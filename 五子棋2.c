...
int p;
 ...
 int ch;
    ...
    case 0xE0:
        switch(ch=getch())
        {
        case 72: if(weizhi.y<=0)weizhi.y=19;else weizhi.y--;gotoxy(weizhi.x,weizhi.y);break;
        case 80: if(weizhi.y>=19)weizhi.y=0;else weizhi.y++;gotoxy(weizhi.x,weizhi.y);break;
        case 75: if(weizhi.x<=0)weizhi.x=19;else weizhi.x--;gotoxy(weizhi.x,weizhi.y);break;
        case 77: if(weizhi.x>=19)weizhi.x=0;else weizhi.x++;gotoxy(weizhi.x,weizhi.y); break;
        default:
        break;
         }
        break;
    case 101:luozi();break;
    case 113:drawqipan();break;
    default:
        break;
    }  
